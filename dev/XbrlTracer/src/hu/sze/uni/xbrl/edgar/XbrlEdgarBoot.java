...
public class XbrlEdgarBoot implements XbrlEdgarConsts {
	...
	public static void zipRead() throws Exception {
		...
		Dust.access(hCsvStream, MIND_TAG_ACCESS_SET, MISC_TAG_DIRECTION_OUT, MIND_ATT_KNOWLEDGE_TAGS, MISC_TAG_DIRECTION);
		Dust.access(hCsvStream, MIND_TAG_ACCESS_SET, RESOURCE_TAG_STREAMTYPE_TEXT, MIND_ATT_KNOWLEDGE_TAGS, RESOURCE_TAG_STREAMTYPE);
		Dust.access(hCsvStream, MIND_TAG_ACCESS_INSERT, hLogFSRoot, MIND_ATT_KNOWLEDGE_LISTENERS, KEY_ADD);

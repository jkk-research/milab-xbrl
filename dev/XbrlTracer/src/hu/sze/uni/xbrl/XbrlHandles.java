...
public interface XbrlHandles extends DustConsts {
	...
	MindHandle XBRLDOCK_ASP_DATABROWSERIN = Dust.lookup(XBRLDOCK_GEN);
	MindHandle XBRLDOCK_ATT_DATABROWSERIN_CFTAX = Dust.lookup(XBRLDOCK_GEN);
	MindHandle XBRLDOCK_ATT_DATABROWSERIN_CFNAME = Dust.lookup(XBRLDOCK_GEN);
	MindHandle XBRLDOCK_ATT_DATABROWSERIN_CFSEL = Dust.lookup(XBRLDOCK_GEN);
	
	MindHandle XBRLDOCK_TAG_DATABROWSERINCMD = Dust.lookup(XBRLDOCK_GEN);
	MindHandle XBRLDOCK_TAG_DATABROWSERINCMD_SETCFTAX = Dust.lookup(XBRLDOCK_GEN);
	MindHandle XBRLDOCK_TAG_DATABROWSERINCMD_SETCFNAME = Dust.lookup(XBRLDOCK_GEN);
	MindHandle XBRLDOCK_TAG_DATABROWSERINCMD_CFSELADD = Dust.lookup(XBRLDOCK_GEN);
	
	MindHandle XBRLDOCK_ASP_DATABROWSEROUT = Dust.lookup(XBRLDOCK_GEN);
	MindHandle XBRLDOCK_ATT_DATABROWSEROUT_TAXONOMIES = Dust.lookup(XBRLDOCK_GEN);
	MindHandle XBRLDOCK_ATT_DATABROWSEROUT_CONCEPTS = Dust.lookup(XBRLDOCK_GEN);

	MindHandle XBRLDOCK_NAR_DATABROWSER = Dust.lookup(XBRLDOCK_GEN);

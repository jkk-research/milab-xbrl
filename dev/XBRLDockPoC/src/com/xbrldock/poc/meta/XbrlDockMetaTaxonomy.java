...
public class XbrlDockMetaTaxonomy implements XbrlDockMetaConsts {
	...
	public XbrlDockMetaTaxonomy(String taxId, File fMetaInf, XbrlDockTaxonomyManager tmgr) throws Exception {
		this.id = taxId;
...
//			}
	...
	public Map getItem(String itemRef, String id, String currPath) throws Exception {
		String realRef = XbrlDockUtils.optExtendRef(itemRef, currPath);
...
//					ns = e.getAttribute("namespace");
				...
				if (null != sl) {
					sl = XbrlDockUtils.optExtendRef(sl, path);
					optQueue(sl);
				}
			}
		}

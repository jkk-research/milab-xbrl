...
//		taxMgr.importTaxonomy(new File("ext/XBRLDock/temp/IFRST_2021-03-24.zip"));
		callAgent(XDC_CFGTOKEN_AGENT_taxmgr, XDC_CMD_TAXMGR_IMPORT, new File("ext/XBRLDock/taxonomy/import/2024-09-26T16_13_08"));
//		callAgent(XDC_CFGTOKEN_AGENT_taxmgr, XDC_CMD_TAXMGR_IMPORT, new File("ext/XBRLDock/taxonomy/import/esef_taxonomy_2021"));
